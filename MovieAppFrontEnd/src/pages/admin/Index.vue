                ...
                <q-td key="judulFilm" :props="props">
                 ...
                 <q-td key="nama" :props="props">
                  ...
                  <q-td key="aksi" :props="props">
                    <q-btn label="Detail" @click="openDetail(props.row)" color="dark" unelevated/>
                    <q-btn :disabled="props.row.status !== 1" label="Konfirmasi" @click="confirm(props.row._id)" class="q-ml-lg" color="dark" unelevated />
                </q-td>
              </q-tr>
            </template>
            </q-table>

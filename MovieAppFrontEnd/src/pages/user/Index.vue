<template>
    ...
    >
      <q-carousel-slide :name="1" img-src="https://zetizen.radarcirebon.com/wp-content/uploads/2020/09/csgo-breaks-record-for-highest-player-count-all-time.jpg" />
      <q-carousel-slide :name="2" img-src="https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota2_social.jpg" />
      <q-carousel-slide :name="3" img-src="https://images.contentstack.io/v3/assets/bltb6530b271fddd0b1/blt86cd8572a30911aa/60cbfdb00ece0255888d895a/V_Ep_03_REFLECTION_Article-Header.jpg?auto=webp&disable=upscale&height=1055" />
      <q-carousel-slide :name="4" img-src="https://cdn1-production-images-kly.akamaized.net/_tWqfGzYY8KheCP8uJwZWhQx98Q=/640x360/smart/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/796713/original/094485900_1421485203-GTAV-Review.jpg" />
    ...
    <div class="row q-col-gutter-md">
      ...
      <q-card-actions>
        <q-btn unelevated @click="openDetail(movie)" class="full-width" color="dark">
          Order Now
        </q-btn>
      </q-card-actions>
    </q-card>

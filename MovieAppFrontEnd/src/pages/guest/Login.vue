                            ...
                            <div class="row items-center">
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        <q-card-section>
                                            <q-btn class="full-width" type="submit" unelevated color="dark " label="Login"/>
                                            <q-btn class="full-width q-mt-md" :to="{ name: 'RegisterPage' }" flat unelevated color="dark " label="Register"/>
                                        </q-card-section>
                                    </q-form>
                                </div>
                            </div>
